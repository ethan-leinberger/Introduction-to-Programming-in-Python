...
class Hangman_Interface:
    ...
    def draw_initial_scene(self):
        ...
        self.canvas.create_line(200, 50, 200, 80, width=3, fill='brown')
        self.canvas.create_rectangle(197, 70, 203, 80, fill='brown')
        self.canvas.create_oval(10, 10, 60, 60, fill='yellow')
    ...
    def process_guess(self, letter):
        ...
        if status != 'ongoing':
            ...
            if status == 'won':
                ...
                self.left_eye = self.canvas.create_text(191, 99, text='X', font=('Arial', 10))
                self.right_eye = self.canvas.create_text(206, 99, text='X', font=('Arial', 10))
    ...
    def update_figure(self):
        ...
        if body_parts == 1:
            ...
            self.canvas.create_line(200, 130, 200, 170, width=2)
        elif body_parts == 3:
            self.canvas.create_line(200, 150, 170, 120, width=2)
        elif body_parts == 4:
            self.canvas.create_line(200, 150, 230, 120, width=2)
        elif body_parts == 5:
